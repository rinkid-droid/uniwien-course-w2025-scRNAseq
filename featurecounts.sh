...
featureCounts -p --countReadPairs --ignoreDup -C -T 4 -s 2 --primary -a $wd/test.gtf -o $outDir/featureCounts.tsv $wd/results/map/filtered_trimmed_SRR36631310_WBCel.bam
